...
namespace Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\DailyExpeditionResource\Forms;

use Dpb\Package\TaskMS\UI\Filament\Components\ActivityTemplatePicker;
use Dpb\Package\TaskMS\Services\TS\ActivityService;
...
class VehicleRepeater
{
    public static function make1(string $uri, Collection|null $options = null): Component
    {
        return TableRepeater::make($uri)
            ...
            // ->columnSpan(4)
            ->headers([
                Header::make('vehicle')->label(__('tms-ui::fleet/daily-expedition.form.fields.vehicles.vehicle')),
                Header::make('state')->label(__('tms-ui::fleet/daily-expedition.form.fields.vehicles.state')),
                Header::make('service')->label(__('tms-ui::fleet/daily-expedition.form.fields.vehicles.service')),
                Header::make('note')->label(__('tms-ui::fleet/daily-expedition.form.fields.vehicles.note'))
    ...
    public static function make(string $uri, Collection|null $options = null): Component
    {
        return Repeater::make($uri)
            ...
            ->schema([
                ...
                // Forms\Components\TextInput::make('service')
                //     ->hiddenLabel()
                //     ->placeholder(__('tms-ui::fleet/daily-expedition.form.fields.vehicles_repeater.fields.service'))
                //     ->columnSpan(1),
                // note
                ...
                //         Forms\Components\TextInput::make('note')
                //             ->hiddenLabel()
                //             ->placeholder(__('tms-ui::fleet/daily-expedition.form.fields.vehicles_repeater.fields.note'))
                //             ->columnSpan(3),
                //     ])
            ])
            ->default($options)

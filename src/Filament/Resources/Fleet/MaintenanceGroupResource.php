...
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\MaintenanceGroupResource\Pages;
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\MaintenanceGroupResource\Forms\MaintenanceGroupForm;
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\MaintenanceGroupResource\Tables\MaintenanceGroupTable;
...
class MaintenanceGroupResource extends Resource
{
    ...
    {
        return __('tms-ui::fleet/maintenance-group.resource.model_label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('tms-ui::fleet/maintenance-group.resource.plural_model_label');
    }

    public static function getNavigationLabel(): string
    {
        return __('tms-ui::fleet/maintenance-group.navigation.label');
    }

    public static function getNavigationGroup(): ?string
    {
        return __('tms-ui::fleet/maintenance-group.navigation.group');
    }

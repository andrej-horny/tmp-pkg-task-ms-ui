...
use Dpb\Package\TaskMS\UI\Filament\Imports\Fleet\VehicleImporter;
...
class VehicleTable
{
    ...
    {
        return $table
            ->heading(__('tms-ui::fleet/vehicle.table.heading'))
            ->emptyStateHeading(__('tms-ui::fleet/vehicle.table.empty_state_heading'))
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('code.code')
                    ->label(__('tms-ui::fleet/vehicle.table.columns.code'))
                ...
                Tables\Columns\TextColumn::make('licencePlate')
                    ->label(__('tms-ui::fleet/vehicle.table.columns.licence_plate'))
                    ->searchable(query: function (Builder $query, string $search): Builder {
                        return $query
                ...
                //     ->label(__('tms-ui::fleet/vehicle.table.columns.type')),
                // Tables\Columns\TextColumn::make('groups.title')
                //     ->label(__('tms-ui::fleet/vehicle.table.columns.groups')),
                Tables\Columns\TextColumn::make('department')
                    ->label(__('tms-ui::fleet/vehicle.table.columns.department')),
                ...
                //     ->label(__('tms-ui::fleet/vehicle.table.columns.total_distance'))
                ...
                //     ->label(__('tms-ui::fleet/vehicle.table.columns.distance_since_inspection'))
                //     ->state(function ($record, VehicleService $vehicleService) {
                ...
                Tables\Columns\TextColumn::make('maintenanceGroup.code')
                    ...
                    ->tooltip(__('tms-ui::fleet/vehicle.table.columns.maintenance_group.tooltip'))
                    ->badge(),
                ...
                Tables\Columns\IconColumn::make('is_under_warranty')
                    ->label(__('tms-ui::fleet/vehicle.table.columns.under_warranty.label'))
                    ->tooltip(__('tms-ui::fleet/vehicle.table.columns.under_warranty.tooltip'))
                    ->boolean()

...
use Dpb\Package\TaskMS\UI\Filament\Imports\Fleet\VehicleGroupImporter;
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\VehicleGroupResource\Forms\VehicleGroupForm;
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\VehicleGroupResource\Pages;
use Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\VehicleGroupResource\Tables\VehicleGroupTable;
...
class VehicleGroupResource extends Resource
{
    ...
    {
        return __('tms-ui::fleet/vehicle-group.resource.model_label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('tms-ui::fleet/vehicle-group.resource.plural_model_label');
    }

    public static function getNavigationLabel(): string
    {
        return __('tms-ui::fleet/vehicle-group.navigation.label');
    }

    public static function getNavigationGroup(): ?string
    {
        return __('tms-ui::fleet/vehicle-group.navigation.group');
    }

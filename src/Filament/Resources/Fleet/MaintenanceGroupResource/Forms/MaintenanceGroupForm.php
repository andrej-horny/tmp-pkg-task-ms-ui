...
namespace Dpb\Package\TaskMS\UI\Filament\Resources\Fleet\MaintenanceGroupResource\Forms;
    ...
    public static function schema(): array
    {
        return [
            ...
            Forms\Components\ToggleButtons::make('vehicle_type_id')
                ->label(__('tms-ui::fleet/maintenance-group.form.fields.vehicle_type.label'))
                ->hint(__('tms-ui::fleet/maintenance-group.form.fields.vehicle_type.hint'))
                ->columnSpan(4)

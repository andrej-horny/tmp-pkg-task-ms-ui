...
use Dpb\Package\TaskMS\UI\Filament\Resources\Ticket\TicketTypeResource\Forms\TicketTypePicker;
use Carbon\Carbon;
...
class TicketAssignmentForm
{
    ...
    public static function schema1(): array
    {
        return [
            ...
            // ->required(false),
            // ticket type
            TicketTypePicker::make('ticket.type_id'),
            // Forms\Components\ToggleButtons::make('ticket.type_id')
            //     ->label(__('tms-ui::tickets/ticket.form.fields.type'))
            //     ->inline()
            //     ->columnSpan(1)
            //     ->options(
